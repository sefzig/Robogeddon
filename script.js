...
// Konversationen 
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // Gruppen
          if (~befehl.indexOf("--TESTS")) { versuch = true; return bot.say(TechnikBot+' Zu testende Funktionen: --Inhalte, --Buttons, --Stile, --Menüs und --Javascript. Läuft das alles? ').then(() => 'technik');}          if (~befehl.indexOf("--TEST")) { versuch = true; return bot.say(TechnikBot+' Ich habe gerade unsere Funktionen überarbeitet: --Inhalte, --Buttons, --Stile, --Menüs und --Javascript. Mögen Sie einmal schauen, ob alles läuft? ').then(() => 'technik');}          if (~befehl.indexOf("--INHALTE")) { versuch = true; return bot.say(TechnikBot+' Inhalte: --Text, --Bild, --Qr und --Youtube. ').then(() => 'technik');}          if (~befehl.indexOf("--BUTTONS")) { versuch = true; return bot.say(TechnikBot+' Buttons: --Link, --Textlink, --Linkliste, --Button, --Action, --Email und --Telefon. ').then(() => 'technik');}          if (~befehl.indexOf("--STILE")) { versuch = true; return bot.say(TechnikBot+' Stile: --StilTag, --StilNacht, --StilRobo und --StilHx. ').then(() => 'technik');}          if (~befehl.indexOf("--MENÜS")) { versuch = true; return bot.say(TechnikBot+' Menü: --Menue, --MenuAn und --MenuAus. ').then(() => 'technik');}          if (~befehl.indexOf("--JAVASCRIPT")) { versuch = true; return bot.say(TechnikBot+' Javascript: --Alert, --Konsole und --Cookie. ').then(() => 'technik');}          
       // Links (Reihenfolge!!!)
          if (~befehl.indexOf("--LINK")) { versuch = true; return bot.say(TechnikBot+' [Link:Ein Demo-Link,TestLink] Dieser Button öffnet einen (vorab gespeicherten) Link in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Textlink, --Linkliste, --Button, --Action, --Email und --Telefon. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--TEXTLINK")) { versuch = true; return bot.say(TechnikBot+' [Textlink:Ein Demo-Textlink,TestLink] Dieser Textlink öffnet einen (vorab gespeicherten) Link in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Link, --Linkliste, --Button, --Action, --Email und --Telefon. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--LINKLISTE")) { versuch = true; return bot.say(TechnikBot+' [Linkliste:Eine Demo-Linkliste,Rtm:Strategie:Artikel] Dieser Button öffnet eine Linkliste in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Link, --Textlink, --Button, --Action, --Email und --Telefon. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--BUTTON")) { versuch = true; return bot.say(TechnikBot+' [Button:Ein Demo-Button,http://example.com] Dieser Button öffnet einen externen Link im neuen Fenster. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Link, --Textlink, --Linkliste, --Action, --Email und --Telefon. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--ACTION")) { versuch = true; return bot.say(TechnikBot+' %[Eine Demo-Action](http://sefzig.net/link/TestLink/) Dieser Button startet eine Smooch-Action. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Link, --Textlink, --Linkliste, --Button, --Email und --Telefon. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--EMAIL")) { versuch = true; return bot.say(TechnikBot+' [Email:andreas.sefzig@robogeddon.de] Dieser Button öffnet eine neue E-Mail an eine vorgegebene Adresse. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Link, --Textlink, --Linkliste, --Button, --Action und --Telefon. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--TELEFON")) { versuch = true; return bot.say(TechnikBot+' [Telefon:+49 151 15920082] Dieser Button startet einen Anruf an eine vorgegebene Telefonnummer. ').then(() => bot.say(TechnikBot+' Weitere Buttons: --Link, --Textlink, --Linkliste, --Button, --Action und --Email. Oder andere --Tests? ')).then(() => 'technik');}          
       // Inhalte
