...
// Konversationen 
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // Links
          if (~befehl.indexOf("--LINK")) { versuch = true; return bot.say(TechnikBot+' [Link:Ein Demo-Link,TestLink] Dieser Button öffnet einen (vorab gespeicherten) Link in einer Lightbox. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--TEXTLINK")) { versuch = true; return bot.say(TechnikBot+' [Textlink:Ein Demo-Textlink,TestLink] Dieser Textlink öffnet einen (vorab gespeicherten) Link in einer Lightbox. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--LINKLISTE")) { versuch = true; return bot.say(TechnikBot+' [Linkliste:Eine Demo-Linkliste,Rtm:Strategie:Artikel] Dieser Button öffnet eine Linkliste in einer Lightbox. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--BUTTON")) { versuch = true; return bot.say(TechnikBot+' [Button:Ein Demo-Button,http://example.com] Dieser Button öffnet einen externen Link im neuen Fenster. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--ACTION")) { versuch = true; return bot.say(TechnikBot+' %[Eine Demo-Action](http://sefzig.net/link/TestLink/) Dieser Button startet eine Smooch-Action. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--EMAIL")) { versuch = true; return bot.say(TechnikBot+' [Email:andreas.sefzig@robogeddon.de] Dieser Button öffnet eine neue E-Mail an eine vorgegebene Adresse. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--TELEFON")) { versuch = true; return bot.say(TechnikBot+' [Telefon:+49 151 15920082] Dieser Button startet einen Anruf an eine vorgegebene Telefonnummer. ').then(() => bot.say(TechnikBot+' Mehr --Links, --Tests, --Technik? ')).then(() => 'technik');}          
       // Stile
