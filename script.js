...
// Konversationen 
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // Inhalte
          if (~befehl.indexOf("--TEXT")) { versuch = true; return bot.say(TechnikBot+' [Text:Ein Demo-Text,RobogeddonDemotext] Dieser Button öffnet einen Text in einer Lightbox. ').then(() => bot.say(TechnikBot+' Mehr --Inhalte, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--BILD")) { versuch = true; return bot.say(TechnikBot+' [Bild:http://sefzig.net/text/seiten/SefzigBot/dateien/Mesaging_vs_Social.png] Dieses Bild kann durch in einer Lightbox vergrößert werden. ').then(() => bot.say(TechnikBot+' Mehr --Inhalte, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--QR")) { versuch = true; return bot.say(TechnikBot+' [Qr:http://sefzigbot.herokuapp.com/] Dieser QR-Code öffnet eine URL via QR-Reader. ').then(() => bot.say(TechnikBot+' Mehr --Inhalte, --Tests, --Technik? ')).then(() => 'technik');}          if (~befehl.indexOf("--YOUTUBE")) { versuch = true; return bot.say(TechnikBot+' [Youtube:C0DPdy98e4c] Dieses Test-Video wird im Youtube-Player geladen. ').then(() => bot.say(TechnikBot+' Mehr --Inhalte, --Tests, --Technik? ')).then(() => 'technik');}          
       // Links
