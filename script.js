 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--HELFE")) { versuch = true; return bot.say(KreationsBot+' Das ist nett von Ihnen! Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => 'technik');}          
       // -----------------
       // Vorlage
       // -----------------
