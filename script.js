...
// Konversationen 
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // Gruppen
          if (~befehl.indexOf("--TESTS")) { versuch = true; return bot.say(TechnikBot+' Zu testende Funktionen: --Inhalte, --Elemente, --Stile, --Menüs und --Javascript. Läuft das alles? ').then(() => 'technik');}          if (~befehl.indexOf("--TEST")) { versuch = true; return bot.say(TechnikBot+' Ich habe gerade unsere Funktionen überarbeitet: --Inhalte, --Elemente, --Stile, --Menüs und --Javascript. Mögen Sie einmal schauen, ob alles läuft? ').then(() => 'technik');}          if (~befehl.indexOf("--INHALTE")) { versuch = true; return bot.say(TechnikBot+' Inhalte: --Text, --Bild, --Qr und --Youtube. ').then(() => 'technik');}          if (~befehl.indexOf("--ELEMENT")) { versuch = true; return bot.say(TechnikBot+' Elemente: --Link, --Textlink, --Linkliste, --Button, --Action, --Email und --Telnr. ').then(() => 'technik');}          if (~befehl.indexOf("--STILE")) { versuch = true; return bot.say(TechnikBot+' Stile: --StilTag, --StilNacht, --StilRobo und --StilHx. ').then(() => 'technik');}          if (~befehl.indexOf("--MENÜS")) { versuch = true; return bot.say(TechnikBot+' Menü: --Menue, --MenuAn und --MenuAus. ').then(() => 'technik');}          if (~befehl.indexOf("--JAVASCRIPT")) { versuch = true; return bot.say(TechnikBot+' Javascript: --Alert, --Konsole und --Cookie. ').then(() => 'technik');}          
