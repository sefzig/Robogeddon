 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--DANKS")) { versuch = true; return bot.say(SefzigBot+' Auch ich, %name_frau%, danke Nadja, Bob meinen (ehemaligen) Kollegen und meinen Eltern für ihre Geduld mit mir und meinen Bots. ').then(() => 'empfang');}	       
       ...
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren!  ')).then(() => bot.say(BeratungsBot+' Oder wollen Sie einen --Chatraum wie diesen hier? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren!  ')).then(() => bot.say(BeratungsBot+' Oder wollen Sie einen --Chatraum wie diesen hier? ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. Unser Highlight-Produkt ist der --Chatraum für den wir Ihnen ein günstiges --Angebot machen möchten! ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. Unser Highlight-Produkt ist der --Chatraum für den wir Ihnen ein günstiges --Angebot machen möchten! ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--DANKS")) { versuch = true; return bot.say(SefzigBot+' Auch ich, %name_frau%, danke Nadja, Bob meinen (ehemaligen) Kollegen und meinen Eltern für ihre Geduld mit mir und meinen Bots. ').then(() => 'beratung');}	       
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--VORTEIL")) { versuch = true; return bot.say(BeratungsBot+' Die Gründe, warum Sie einen Chatraum haben wollen: [Text:Chatraum: Vorteile,ChatraumVorteile,] ').then(() => bot.say(BeratungsBot+' Echter Dialog mit echten Kunden - und gut gemachten Chat-Bots! ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--ANGEBOT")) { versuch = true; return bot.say(BeratungsBot+' Wir möchten Ihnen ein Angebot machen: [Text:3000 € inkl. 2 Updates,ChatraumAngebot,] Zurück zu --Chatraum. ').then(() => 'beratung');}          
          if (~befehl.indexOf("--VORGEHEN")) { versuch = true; return bot.say(BeratungsBot+' Ihr Chatraum wird entlang eines robusten Prozesses eingerichtet: Alle Konversationen, Texte und Medien befinden sich in einem Ihnen zugänglichen, übersichtlichen Dokument. ').then(() => bot.say(BeratungsBot+' Wie der Projektablauf für Sie aussieht: [Text:Chatraum: Vorgehen,ChatraumVorgehen,] Zurück zu --Chatraum. ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--BEISPIEL")) { versuch = true; return bot.say(BeratungsBot+' Sie können Ihren Chatraum einfach in beliebigen Marketing-Kanälen verlinken. ').then(() => bot.say(KonzeptionsBot+' Schreiben Sie --Konzeption, wenn Sie mehr über die Kanäle von mir erfahren wollen... ')).then(() => bot.say(BeratungsBot+' Anwendungsbeispiele: [Text:Chatraum: Beispiele,ChatraumBeispiele,] Zurück zu --Chatraum. ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--VORLAGE")) { versuch = true; return bot.say(BeratungsBot+' Testen Sie die Vorlage (in einem neuen Fenster): [Button:Demo-Version,http://chatraum.herokuapp.com] ').then(() => 'beratung');}          
       // -----------------
       // Leistungen
       // -----------------
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--DANKS")) { versuch = true; return bot.say(SefzigBot+' Auch ich, %name_frau%, danke Nadja, Bob meinen (ehemaligen) Kollegen und meinen Eltern für ihre Geduld mit mir und meinen Bots. ').then(() => 'technik');}	       
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--DANKS")) { versuch = true; return bot.say(SefzigBot+' Auch ich, %name_frau%, danke Nadja, Bob meinen (ehemaligen) Kollegen und meinen Eltern für ihre Geduld mit mir und meinen Bots. ').then(() => 'kreation');}	       
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--DANKS")) { versuch = true; return bot.say(SefzigBot+' Auch ich, %name_frau%, danke Nadja, Bob meinen (ehemaligen) Kollegen und meinen Eltern für ihre Geduld mit mir und meinen Bots. ').then(() => 'konzeption');}	       
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--DANKS")) { versuch = true; return bot.say(SefzigBot+' Auch ich, %name_frau%, danke Nadja, Bob meinen (ehemaligen) Kollegen und meinen Eltern für ihre Geduld mit mir und meinen Bots. ').then(() => 'strategie');}	       
