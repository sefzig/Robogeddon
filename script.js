 ...
 // ---------------------------
    ...
    empfang: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--KONTAKT")) { versuch = true; return bot.say(EmpfangsBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(EmpfangsBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'empfang');}if (~befehl.indexOf("--ANFRAGE")) { versuch = true; return bot.say(EmpfangsBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(EmpfangsBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'empfang');}          
          ...
          if (~befehl.indexOf("--TWITTER")) { versuch = true; return bot.say(EmpfangsBot+' Tweeten Sie mit uns auf Twitter: [Text:@robogeddon,RobogeddonTwitter,] ').then(() => 'empfang');}          
          if (~befehl.indexOf("--XING")) { versuch = true; return bot.say(EmpfangsBot+' Andreas Sefzig ist Premium-Mitglied bei XING: [Text:Andreas Sefzig auf XING,RobogeddonXing,] ').then(() => 'empfang');}          
          if (~befehl.indexOf("--SLACK-TEAM")) { versuch = true; return bot.say(EmpfangsBot+' Treten Sie unserem offenen Slack-Team bei: [Text:Unser offenes Slack,RobogeddonSlackteam,] ').then(() => 'empfang');}          
       // -----------------
       // Über uns
       // -----------------
       ...
       // Produkte
          if ("empfang" != "beratung") {
             ...
             if (~befehl.indexOf("--PRODUKT")) { versuch = true; return bot.say(BeratungsBot+' Unsere Produkte sind Ihre Marketing-Chat-Bots. Wir entwickeln die technischen --Lösungen für Sie und bieten tatkräftige Unterstützung als --Leistung an. ').then(() => 'beratung');}	       
          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--MOBIL")) { versuch = true; return bot.say(EmpfangsBot+' Diesen Chat mobil öffnen: [Qr:http://robogeddon.herokuapp.com/] ').then(() => bot.say(TechnikBot+' Leider werden Sie dort nicht automatisch wiedererkannt. Wir arbeiten an einer Lösung... ')).then(() => bot.say(EmpfangsBot+' Oder öffnen Sie [Textlink:Robogeddon.de,http://robogeddon.de] in Ihrem mobilen Browser. ')).then(() => 'empfang');}          
       // Stile
          if (~befehl.indexOf("--TAG")) { versuch = true; return bot.say(EmpfangsBot+' [Javascript:stil(tag)] Guten Tag. ').then(() => 'empfang');}          if (~befehl.indexOf("--NACHT")) { versuch = true; return bot.say(EmpfangsBot+' [Javascript:stil(nacht)] Gute Nacht. ').then(() => 'empfang');}          if (~befehl.indexOf("--ROBOS")) { versuch = true; return bot.say(EmpfangsBot+' [Javascript:stil(robogeddon)] Die Robos kommen! ').then(() => 'empfang');}          if (~befehl.indexOf("--HX")) { versuch = true; return bot.say(EmpfangsBot+' [Javascript:stil(hacks)] Powned! ').then(() => 'empfang');}          
       // -----------------
       // Bots
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(EmpfangsBot+' Ich übergebe an Barbara. Schreiben Sie --Empfang, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
 ...
 // ---------------------------
    ...
    beratung: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--KONTAKT")) { versuch = true; return bot.say(BeratungsBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(BeratungsBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'beratung');}if (~befehl.indexOf("--ANFRAGE")) { versuch = true; return bot.say(BeratungsBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(BeratungsBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'beratung');}          
          ...
          if (~befehl.indexOf("--TWITTER")) { versuch = true; return bot.say(BeratungsBot+' Tweeten Sie mit uns auf Twitter: [Text:@robogeddon,RobogeddonTwitter,] ').then(() => 'beratung');}          
          if (~befehl.indexOf("--XING")) { versuch = true; return bot.say(BeratungsBot+' Andreas Sefzig ist Premium-Mitglied bei XING: [Text:Andreas Sefzig auf XING,RobogeddonXing,] ').then(() => 'beratung');}          
          if (~befehl.indexOf("--SLACK-TEAM")) { versuch = true; return bot.say(BeratungsBot+' Treten Sie unserem offenen Slack-Team bei: [Text:Unser offenes Slack,RobogeddonSlackteam,] ').then(() => 'beratung');}          
       // -----------------
       // Über uns
       // -----------------
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--MOBIL")) { versuch = true; return bot.say(BeratungsBot+' Diesen Chat mobil öffnen: [Qr:http://robogeddon.herokuapp.com/] ').then(() => bot.say(TechnikBot+' Leider werden Sie dort nicht automatisch wiedererkannt. Wir arbeiten an einer Lösung... ')).then(() => bot.say(BeratungsBot+' Oder öffnen Sie [Textlink:Robogeddon.de,http://robogeddon.de] in Ihrem mobilen Browser. ')).then(() => 'beratung');}          
       // Stile
          if (~befehl.indexOf("--TAG")) { versuch = true; return bot.say(BeratungsBot+' [Javascript:stil(tag)] Guten Tag. ').then(() => 'beratung');}          if (~befehl.indexOf("--NACHT")) { versuch = true; return bot.say(BeratungsBot+' [Javascript:stil(nacht)] Gute Nacht. ').then(() => 'beratung');}          if (~befehl.indexOf("--ROBOS")) { versuch = true; return bot.say(BeratungsBot+' [Javascript:stil(robogeddon)] Die Robos kommen! ').then(() => 'beratung');}          if (~befehl.indexOf("--HX")) { versuch = true; return bot.say(BeratungsBot+' [Javascript:stil(hacks)] Powned! ').then(() => 'beratung');}          
       // -----------------
       // Bots
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich übergebe an Barbara. Schreiben Sie --Beratung, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BEFEHL")) { versuch = true; return bot.say(BeratungsBot+' Meine Befehle: --Lösungen und --Leistungen, --Beratung, --Mitarbeit und --Slack. ').then(() => 'beratung');}          
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--LÖSUNG")) { versuch = true; return bot.say(BeratungsBot+' Wir entwickeln Chat-Lösungen für die interne und externe Kommunikation. Unser Highlight ist der --Chatraum, in dem Nutzer mit Ihnen und-oder Ihren Bots sprechen. Oder sollen Ihre --Bots in anderen Kanälen wie Facebook oder Telegram laufen? ').then(() => bot.say(BeratungsBot+' Zudem verfügen wir über Werkzeuge und Vorlagen für --ChatOps mit #Slack, der neuen Art der Internen Kommunikation. ')).then(() => bot.say(BeratungsBot+' Oder wollen wir zurück zur --Beratung gehen? ')).then(() => 'beratung');}	       
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--CHATRAUM")) { versuch = true; return bot.say(BeratungsBot+' Chatraum ist eine für alle Bildschirme optimierte Internet-Anwendung, die eine direkte und teilautomatisierte 1-zu-1-Verbindung zu Ihren Kunden herstellt. Sie befinden sich gerade in einem Chatraum! ').then(() => bot.say(BeratungsBot+' Über Chatraum sprechen Ihre Nutzer mit einem oder mehreren Ihrer Bots - je nach Einstellung auch bzw. oder mit Ihnen: [Text:Produktbeschreibung,ChatraumDokumentation,] ')).then(() => bot.say(BeratungsBot+' Lesen Sie mehr über die --Vorteile, Anwendungs- --Beispiele, unser --Angebot an Sie und unser --Vorgehen! ')).then(() => 'beratung');}	       
          if (~befehl.indexOf("--VORTEIL")) { versuch = true; return bot.say(BeratungsBot+' Echter Dialog mit echten Kunden - und gut gemachten Chat-Bots. ').then(() => bot.say(BeratungsBot+' Warum Sie einen Chatraum haben wollen: [Text:Chatraum: Vorteile,ChatraumVorteile,] ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--ANGEBOT")) { versuch = true; return bot.say(BeratungsBot+' Wir möchten Ihnen ein Angebot unterbreiten! ').then(() => bot.say(BeratungsBot+' Unser Angebot auf einen Blick: [Text:Chatraum: Angebot,ChatraumAngebot,] ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--VORGEHEN")) { versuch = true; return bot.say(BeratungsBot+' Wir haben einen robusten Prozess für die Einrichtung Ihres Chatraums entwickelt: Alle Konversationen, Texte und Medien befinden sich in einem Ihnen zugänglichen, übersichtlichen Dokument. ').then(() => bot.say(BeratungsBot+' Wie der Projektablauf für Sie aussieht: [Text:Chatraum: Vorgehen,ChatraumVorgehen,] ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--BEISPIEL")) { versuch = true; return bot.say(BeratungsBot+' Sie können Ihren Chatraum einfach in beliebigen Marketing-Kanälen verlinken: [Text:Chatraum: Beispiele,ChatraumBeispiele,] ').then(() => bot.say(KonzeptionsBot+' Schreiben Sie --Beratung, wenn Sie mehr über die Kanäle erfahren wollen! ')).then(() => 'beratung');}          
          if (~befehl.indexOf("--TESTEN")) { versuch = true; return bot.say(BeratungsBot+' Testen Sie die Vorlage in einem neuen Fenster: [Button:Demo-Version,http://chatraum.herokuapp.com] ').then(() => 'beratung');}          
       // -----------------
       // Leistungen
       // -----------------
          
          if (~befehl.indexOf("--LEISTUNG")) { versuch = true; return bot.say(BeratungsBot+' Andreas wird Sie gern --beraten. Er würde sicherlich auch operativ an Ihrem Projekt --mitarbeiten. Nach Bedarf bringt er unsere bestehenden Lösungen kostenlos mit ein! ').then(() => bot.say(BeratungsBot+' Nutzen Sie seine Erfahrung bei der --Einführung von Chats und Chat-Bots! ')).then(() => bot.say(BeratungsBot+' Kein Interesse? Dann lassen Sie zurück zur --Beratung gehen. ')).then(() => 'beratung');}	       
 ...
 // ---------------------------
    ...
    technik: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--KONTAKT")) { versuch = true; return bot.say(TechnikBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(TechnikBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'technik');}if (~befehl.indexOf("--ANFRAGE")) { versuch = true; return bot.say(TechnikBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(TechnikBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'technik');}          
          ...
          if (~befehl.indexOf("--TWITTER")) { versuch = true; return bot.say(TechnikBot+' Tweeten Sie mit uns auf Twitter: [Text:@robogeddon,RobogeddonTwitter,] ').then(() => 'technik');}          
          if (~befehl.indexOf("--XING")) { versuch = true; return bot.say(TechnikBot+' Andreas Sefzig ist Premium-Mitglied bei XING: [Text:Andreas Sefzig auf XING,RobogeddonXing,] ').then(() => 'technik');}          
          if (~befehl.indexOf("--SLACK-TEAM")) { versuch = true; return bot.say(TechnikBot+' Treten Sie unserem offenen Slack-Team bei: [Text:Unser offenes Slack,RobogeddonSlackteam,] ').then(() => 'technik');}          
       // -----------------
       // Über uns
       // -----------------
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--MOBIL")) { versuch = true; return bot.say(TechnikBot+' Diesen Chat mobil öffnen: [Qr:http://robogeddon.herokuapp.com/] ').then(() => bot.say(TechnikBot+' Leider werden Sie dort nicht automatisch wiedererkannt. Wir arbeiten an einer Lösung... ')).then(() => bot.say(TechnikBot+' Oder öffnen Sie [Textlink:Robogeddon.de,http://robogeddon.de] in Ihrem mobilen Browser. ')).then(() => 'technik');}          
       // Stile
          if (~befehl.indexOf("--TAG")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(tag)] Guten Tag. ').then(() => 'technik');}          if (~befehl.indexOf("--NACHT")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(nacht)] Gute Nacht. ').then(() => 'technik');}          if (~befehl.indexOf("--ROBOS")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(robogeddon)] Die Robos kommen! ').then(() => 'technik');}          if (~befehl.indexOf("--HX")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(hacks)] Powned! ').then(() => 'technik');}          
       // -----------------
       // Bots
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(TechnikBot+' Ich übergebe an Barbara. Schreiben Sie --Technik, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // Gruppen
          if (~befehl.indexOf("--TESTS")) { versuch = true; return bot.say(TechnikBot+' Zu testende Funktionen: --Inhalte, --Elemente, --Stile, --Menus und --Javascript. Läuft das alles? ').then(() => 'technik');}          if (~befehl.indexOf("--TEST")) { versuch = true; return bot.say(TechnikBot+' Ich habe gerade unsere Funktionen überarbeitet: --Inhalte, --Elemente, --Stile, --Menus und --Javascript. Mögen Sie einmal schauen, ob alles läuft? ').then(() => 'technik');}          if (~befehl.indexOf("--INHALTE")) { versuch = true; return bot.say(TechnikBot+' Inhalte testen: --Text, --Bild, --Qr und --Youtube. ').then(() => 'technik');}          if (~befehl.indexOf("--ELEMENT")) { versuch = true; return bot.say(TechnikBot+' Elemente testen: --Link, --Textlink, --Linkliste, --Button, --Action, --Email und --Telnr. ').then(() => 'technik');}          if (~befehl.indexOf("--STILE")) { versuch = true; return bot.say(TechnikBot+' Stile testen: --StilTag, --StilNacht, --StilRobo und --StilHx. ').then(() => 'technik');}          if (~befehl.indexOf("--MENUS")) { versuch = true; return bot.say(TechnikBot+' Menus testen: --Menu, --MenuAn und --MenuAus. ').then(() => 'technik');}          if (~befehl.indexOf("--JAVASCRIPT")) { versuch = true; return bot.say(TechnikBot+' Javascript testen: --Alert, --Konsole und --Cookie. ').then(() => 'technik');}          
       // Elemente (Reihenfolge!!!)
          if (~befehl.indexOf("--LINKLISTE")) { versuch = true; return bot.say(TechnikBot+' [Linkliste:Eine Demo-Linkliste,Rtm:Strategie:Artikel] Dieser Button öffnet eine Linkliste in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Link, --Textlink, --Button, --Action, --Email und --Telnr. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--LINK")) { versuch = true; return bot.say(TechnikBot+' [Link:Ein Demo-Link,TestLink] Dieser Button öffnet einen (vorab gespeicherten) Link in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Textlink, --Linkliste, --Button, --Action, --Email und --Telnr. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--TEXTLINK")) { versuch = true; return bot.say(TechnikBot+' [Textlink:Ein Demo-Textlink,TestLink] Dieser Textlink öffnet einen (vorab gespeicherten) Link in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Link, --Linkliste, --Button, --Action, --Email und --Telnr. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--BUTTON")) { versuch = true; return bot.say(TechnikBot+' [Button:Ein Demo-Button,http://example.com] Dieser Button öffnet einen externen Link im neuen Fenster. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Link, --Textlink, --Linkliste, --Action, --Email und --Telnr. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--ACTION")) { versuch = true; return bot.say(TechnikBot+' %[Eine Demo-Action](http://sefzig.net/link/TestLink/) Dieser Button startet eine Smooch-Action. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Link, --Textlink, --Linkliste, --Button, --Email und --Telnr. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--EMAIL")) { versuch = true; return bot.say(TechnikBot+' [Email:andreas.sefzig@robogeddon.de] Dieser Button öffnet eine neue E-Mail an eine vorgegebene Adresse. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Link, --Textlink, --Linkliste, --Button, --Action und --Telnr. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--TELNR")) { versuch = true; return bot.say(TechnikBot+' [Telefon:+49 151 15920082] Dieser Button startet einen Anruf an eine vorgegebene Telefonnummer. ').then(() => bot.say(TechnikBot+' Weitere Elemente: --Link, --Textlink, --Linkliste, --Button, --Action und --Email. Oder andere --Tests? ')).then(() => 'technik');}          
       // Inhalte
          if (~befehl.indexOf("--TEXT")) { versuch = true; return bot.say(TechnikBot+' [Text:Ein Demo-Text,RobogeddonDemotext] Dieser Button öffnet einen Text in einer Lightbox. ').then(() => bot.say(TechnikBot+' Weitere --Inhalte: --Bild, --Qr und --Youtube. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--BILD")) { versuch = true; return bot.say(TechnikBot+' [Bild:http://sefzig.net/text/seiten/SefzigBot/dateien/Mesaging_vs_Social.png] Dieses Bild kann in einer Lightbox vergrößert werden. ').then(() => bot.say(TechnikBot+' Weitere --Inhalte: --Text, --Qr und --Youtube. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--QR")) { versuch = true; return bot.say(TechnikBot+' [Qr:http://sefzigbot.herokuapp.com/] Dieser QR-Code öffnet eine URL via QR-Reader. ').then(() => bot.say(TechnikBot+' Weitere --Inhalte: --Text, --Bild und --Youtube. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--YOUTUBE")) { versuch = true; return bot.say(TechnikBot+' [Youtube:C0DPdy98e4c] Dieses Test-Video wird im Youtube-Player geladen. ').then(() => bot.say(TechnikBot+' Weitere --Inhalte: --Text, --Bild und --Qr. Oder andere --Tests? ')).then(() => 'technik');}          
       // Stile
          if (~befehl.indexOf("--STILTAG")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(tag)] Stil geladen: Tag. ').then(() => bot.say(TechnikBot+' Weitere Stile: --StilNacht, --StilRobo und --StilHx. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--STILNACHT")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(nacht)] Stil geladen: Nacht. ').then(() => bot.say(TechnikBot+' Weitere Stile: --StilTag, --StilRobo und --StilHx. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--STILROBO")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(robogeddon)] Stil geladen: Robos. ').then(() => bot.say(TechnikBot+' Weitere Stile: --StilTag, --StilNacht und --StilHx. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--STILHX")) { versuch = true; return bot.say(TechnikBot+' [Javascript:stil(hacks)] Stil geladen: Hx. ').then(() => bot.say(TechnikBot+' Weitere Stile: --StilTag, --StilNacht und --StilRobo. Oder andere --Tests? ')).then(() => 'technik');}          
       // Menu (Reihenfolge!!!)
          if (~befehl.indexOf("--MENUAN")) { versuch = true; return bot.say(TechnikBot+' [Javascript:menu(an)] Menu angeschaltet. ').then(() => bot.say(TechnikBot+' Weitere Menus: --Menu und --MenuAus. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--MENUAUS")) { versuch = true; return bot.say(TechnikBot+' [Javascript:menu(aus)] Menu ausgeschaltet. ').then(() => bot.say(TechnikBot+' Weitere Menus: --Menu und --MenuAn. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--MENU")) { versuch = true; return bot.say(TechnikBot+' [Javascript:menu()] Menu umgeschaltet. ').then(() => bot.say(TechnikBot+' Weitere Menus: --MenuAn und --MenuAus. Oder andere --Tests? ')).then(() => 'technik');}          
       // Javascript
          if (~befehl.indexOf("--ALERT")) { versuch = true; return bot.say(TechnikBot+' [Javascript:alert(123)] Javascript-Alert ausgegeben: 123. ').then(() => bot.say(TechnikBot+' Weitere Javascripts: --Konsole und --Cookie. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--KONSOLE")) { versuch = true; return bot.say(TechnikBot+' [Javascript:konsole(123)] In Konsole geschrieben: 123. ').then(() => bot.say(TechnikBot+' Weitere Javascripts: --Alert und --Cookie. Oder andere --Tests? ')).then(() => 'technik');}          if (~befehl.indexOf("--COOKIE")) { versuch = true; return bot.say(TechnikBot+' [Javascript:cookies(test,123)] Cookie gesetzt: test, 123. ').then(() => bot.say(TechnikBot+' Weitere Javascripts: --Alert und --Konsole. Oder andere --Tests? ')).then(() => 'technik');}          
       // -----------------
       // Vorlage
       // -----------------
 ...
 // ---------------------------
    ...
    kreation: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--KONTAKT")) { versuch = true; return bot.say(KreationsBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(KreationsBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'kreation');}if (~befehl.indexOf("--ANFRAGE")) { versuch = true; return bot.say(KreationsBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(KreationsBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'kreation');}          
          ...
          if (~befehl.indexOf("--TWITTER")) { versuch = true; return bot.say(KreationsBot+' Tweeten Sie mit uns auf Twitter: [Text:@robogeddon,RobogeddonTwitter,] ').then(() => 'kreation');}          
          if (~befehl.indexOf("--XING")) { versuch = true; return bot.say(KreationsBot+' Andreas Sefzig ist Premium-Mitglied bei XING: [Text:Andreas Sefzig auf XING,RobogeddonXing,] ').then(() => 'kreation');}          
          if (~befehl.indexOf("--SLACK-TEAM")) { versuch = true; return bot.say(KreationsBot+' Treten Sie unserem offenen Slack-Team bei: [Text:Unser offenes Slack,RobogeddonSlackteam,] ').then(() => 'kreation');}          
       // -----------------
       // Über uns
       // -----------------
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--MOBIL")) { versuch = true; return bot.say(KreationsBot+' Diesen Chat mobil öffnen: [Qr:http://robogeddon.herokuapp.com/] ').then(() => bot.say(TechnikBot+' Leider werden Sie dort nicht automatisch wiedererkannt. Wir arbeiten an einer Lösung... ')).then(() => bot.say(KreationsBot+' Oder öffnen Sie [Textlink:Robogeddon.de,http://robogeddon.de] in Ihrem mobilen Browser. ')).then(() => 'kreation');}          
       // Stile
          if (~befehl.indexOf("--TAG")) { versuch = true; return bot.say(KreationsBot+' [Javascript:stil(tag)] Guten Tag. ').then(() => 'kreation');}          if (~befehl.indexOf("--NACHT")) { versuch = true; return bot.say(KreationsBot+' [Javascript:stil(nacht)] Gute Nacht. ').then(() => 'kreation');}          if (~befehl.indexOf("--ROBOS")) { versuch = true; return bot.say(KreationsBot+' [Javascript:stil(robogeddon)] Die Robos kommen! ').then(() => 'kreation');}          if (~befehl.indexOf("--HX")) { versuch = true; return bot.say(KreationsBot+' [Javascript:stil(hacks)] Powned! ').then(() => 'kreation');}          
       // -----------------
       // Bots
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KreationsBot+' Ich übergebe an Barbara. Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--TEXT")) { versuch = true; return bot.say(KreationsBot+' Hier ein Text: [Text:Text: Chatraum Formate,RobogeddonShortcodes,] ').then(() => bot.say(KreationsBot+' Zurück zu --Formate? ')).then(() => 'kreation');}          
          ...
          if (~befehl.indexOf("--ZEIG")) { versuch = true; return bot.say(KreationsBot+' Gesehen? [Javascript:alert(Der Bot hat Ihren Browser mittels Javascript direkt angesprochen.)] ').then(() => 'kreation');}          
          if (~befehl.indexOf("--MEHR")) { versuch = true; return bot.say(KreationsBot+' Cynthia testet gerade alle Formate. Wollen Sie Ihr --helfen? ').then(() => 'kreation');}          
          if (~befehl.indexOf("--HELFE")) { versuch = true; return bot.say(KreationsBot+' Das ist nett von Ihnen! Schreiben Sie --Kreation, um wieder mit mir zu sprechen. ').then(() => bot.say(TechnikBot+' Hallo! Ich habe gerade unsere Funktionen überarbeitet: --Inhalte, --Elemente, --Stile, --Menus und --Javascript. Mögen Sie einmal schauen, ob alles läuft? ')).then(() => 'technik');}          
       // -----------------
       // Vorlage
       // -----------------
 ...
 // ---------------------------
    ...
    konzeption: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--TWITTER")) { versuch = true; return bot.say(KonzeptionsBot+' Tweeten Sie mit uns auf Twitter: [Text:@robogeddon,RobogeddonTwitter,] ').then(() => 'konzeption');}          
          if (~befehl.indexOf("--XING")) { versuch = true; return bot.say(KonzeptionsBot+' Andreas Sefzig ist Premium-Mitglied bei XING: [Text:Andreas Sefzig auf XING,RobogeddonXing,] ').then(() => 'konzeption');}          
          if (~befehl.indexOf("--SLACK-TEAM")) { versuch = true; return bot.say(KonzeptionsBot+' Treten Sie unserem offenen Slack-Team bei: [Text:Unser offenes Slack,RobogeddonSlackteam,] ').then(() => 'konzeption');}          
       // -----------------
       // Über uns
       // -----------------
       ...
       // Stile
          if (~befehl.indexOf("--TAG")) { versuch = true; return bot.say(KonzeptionsBot+' [Javascript:stil(tag)] Guten Tag. ').then(() => 'konzeption');}          if (~befehl.indexOf("--NACHT")) { versuch = true; return bot.say(KonzeptionsBot+' [Javascript:stil(nacht)] Gute Nacht. ').then(() => 'konzeption');}          if (~befehl.indexOf("--ROBOS")) { versuch = true; return bot.say(KonzeptionsBot+' [Javascript:stil(robogeddon)] Die Robos kommen! ').then(() => 'konzeption');}          if (~befehl.indexOf("--HX")) { versuch = true; return bot.say(KonzeptionsBot+' [Javascript:stil(hacks)] Powned! ').then(() => 'konzeption');}          
       // -----------------
       // Bots
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(KonzeptionsBot+' Ich übergebe an Barbara. Schreiben Sie --Konzeption, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BEFEHL")) { versuch = true; return bot.say(KonzeptionsBot+' Meine Themen: --Plattformen und --Kanäle. ').then(() => bot.say(KonzeptionsBot+' --Plattformen: --Slack, --Hipchat, --Smooch, --Facebook und --Browser. ')).then(() => bot.say(KonzeptionsBot+' --Kanäle: --CRM, --Webseite, --Social, --Kontakte, --Verpackung, --Orte und --Tipps. ')).then(() => 'konzeption');}
          if (~befehl.indexOf("--ÜBER")) { versuch = true; return bot.say(KonzeptionsBot+' Ich bin Erika, Konzeptions-Bot. ').then(() => bot.say(BeratungsBot+' 90% der Fehler werden in den ersten 10% des Projekts gemacht. Nicht bei uns - dank Erika! ')).then(() => bot.say(KonzeptionsBot+' Ich kenne alle --Kanäle und --Plattformen. ')).then(() => 'konzeption');}          
       // -----------------
       // Kanäle
       // -----------------
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--HIPCHAT")) { versuch = true; return bot.say(KonzeptionsBot+' Text Hipchat. ').then(() => bot.say(KonzeptionsBot+' Weitere --Plattformen oder zurück zur --Konzeption? ')).then(() => 'konzeption');}          
          if (~befehl.indexOf("--SMOOCH")) { versuch = true; return bot.say(KonzeptionsBot+' Text Smooch. ').then(() => bot.say(KonzeptionsBot+' Weitere --Plattformen oder zurück zur --Konzeption? ')).then(() => 'konzeption');}          
          if (~befehl.indexOf("--FACEBOOK")) { versuch = true; return bot.say(KonzeptionsBot+' Text Facebook Messenger. ').then(() => bot.say(KonzeptionsBot+' Weitere --Plattformen oder zurück zur --Konzeption? ')).then(() => 'konzeption');}	       
          if (~befehl.indexOf("--SMS")) { versuch = true; return bot.say(KonzeptionsBot+' Text Sms. ').then(() => bot.say(KonzeptionsBot+' Weitere --Plattformen oder zurück zur --Konzeption? ')).then(() => 'konzeption');}          
          if (~befehl.indexOf("--BROWSER")) { versuch = true; return bot.say(KonzeptionsBot+' Text Browser. ').then(() => bot.say(KonzeptionsBot+' Weitere --Plattformen oder zurück zur --Konzeption? ')).then(() => 'konzeption');}          
       // -----------------
       // Vorlage
       // -----------------
 ...
 // ---------------------------
    ...
    strategie: {
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--KONTAKT")) { versuch = true; return bot.say(StrategieBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(StrategieBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'strategie');}if (~befehl.indexOf("--ANFRAGE")) { versuch = true; return bot.say(StrategieBot+' Alle unsere Kontaktwege: [Text:Kontakt-Seite öffnen,RobogeddonKontakt,einbindung] ').then(() => bot.say(StrategieBot+' Wollen Sie --telefonieren, --mailen, --twittern, in unser --Slack-Team oder zu --Xing? ')).then(() => 'strategie');}          
          ...
          if (~befehl.indexOf("--TWITTER")) { versuch = true; return bot.say(StrategieBot+' Tweeten Sie mit uns auf Twitter: [Text:@robogeddon,RobogeddonTwitter,] ').then(() => 'strategie');}          
          if (~befehl.indexOf("--XING")) { versuch = true; return bot.say(StrategieBot+' Andreas Sefzig ist Premium-Mitglied bei XING: [Text:Andreas Sefzig auf XING,RobogeddonXing,] ').then(() => 'strategie');}          
          if (~befehl.indexOf("--SLACK-TEAM")) { versuch = true; return bot.say(StrategieBot+' Treten Sie unserem offenen Slack-Team bei: [Text:Unser offenes Slack,RobogeddonSlackteam,] ').then(() => 'strategie');}          
       // -----------------
       // Über uns
       // -----------------
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--MOBIL")) { versuch = true; return bot.say(StrategieBot+' Diesen Chat mobil öffnen: [Qr:http://robogeddon.herokuapp.com/] ').then(() => bot.say(TechnikBot+' Leider werden Sie dort nicht automatisch wiedererkannt. Wir arbeiten an einer Lösung... ')).then(() => bot.say(StrategieBot+' Oder öffnen Sie [Textlink:Robogeddon.de,http://robogeddon.de] in Ihrem mobilen Browser. ')).then(() => 'strategie');}          
       // Stile
          if (~befehl.indexOf("--TAG")) { versuch = true; return bot.say(StrategieBot+' [Javascript:stil(tag)] Guten Tag. ').then(() => 'strategie');}          if (~befehl.indexOf("--NACHT")) { versuch = true; return bot.say(StrategieBot+' [Javascript:stil(nacht)] Gute Nacht. ').then(() => 'strategie');}          if (~befehl.indexOf("--ROBOS")) { versuch = true; return bot.say(StrategieBot+' [Javascript:stil(robogeddon)] Die Robos kommen! ').then(() => 'strategie');}          if (~befehl.indexOf("--HX")) { versuch = true; return bot.say(StrategieBot+' [Javascript:stil(hacks)] Powned! ').then(() => 'strategie');}          
       // -----------------
       // Bots
       // -----------------
          ...
          if (zuletzt_klein != "beratung") { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(StrategieBot+' Ich übergebe an Barbara. Schreiben Sie --Strategie, um wieder mit mir zu sprechen. ').then(() => bot.say(BeratungsBot+' Hallo, ich bin Barbara, Beratungs-Bot. Ich möchte Ihnen unsere --Leistungen und --Lösungen präsentieren! ')).then(() => 'beratung');} } else { 
             if (~befehl.indexOf("--BERATUNG")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}if (~befehl.indexOf("--BARBARA")) { versuch = true; return bot.say(BeratungsBot+' Ich möchte Ihnen unsere --Leistungen und --Lösungen nahelegen. ').then(() => bot.say(BeratungsBot+' Oh, kennen Sie eigentlich --Slack? ')).then(() => 'beratung');}          }
       ...
       // -----------------
          ...
          if (~befehl.indexOf("--BEFEHL")) { versuch = true; return bot.say(StrategieBot+' Über --interne Strategie: --Daten, --Team, --Studie. ').then(() => bot.say(StrategieBot+' Über --externe Strategie: --Kanäle, --Aufgaben. ')).then(() => bot.say(StrategieBot+' Kulturphänomen Chat: --Trend, --Marketing, --Szenarien. ')).then(() => bot.say(StrategieBot+' Technologie und Nutzung: --Chat, --Plattformen. ')).then(() => 'strategie');}
